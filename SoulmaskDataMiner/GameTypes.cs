...
namespace SoulmaskDataMiner
{
	...
	internal enum EAttrType
	{
		...
		Tenacity,
		MaxTenacity,
		WeakenTenacityDefense,
		WuQiDamage,
		WuQiDamageDecIgnore,
		WuQiDamageDec,
		WuQiReboundDamageDec,
		DamageInc,
		DamageDec,
		Crit,
		CritDef,
		...
		WaterConsume,
		FoodConsume,
		WaterConsumePctTiLiRecover,
		FoodConsumePctTiLiRecover,
		CannotMove,
		CannotGA,
		CanChuJue,
		CannotDaoJu,
		...
		ParalysisProtection,
		BleedingProtection,
		FallSleepDamageDecRate,
		ParalysisDamageDecRate,
		BleedingDamageDecRate,
		Du,
		MaxDu,
		FuKang,
		FuShe,
