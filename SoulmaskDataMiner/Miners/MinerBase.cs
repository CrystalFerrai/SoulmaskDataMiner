...
namespace SoulmaskDataMiner.Miners
{
	...
	internal abstract class MinerBase : IDataMiner
	{
		...
		/// </summary>
		protected string? CsvStr(string? value)
		{
		...
		/// </summary>
		protected string DbStr(string? value, bool treatNullAsEmpty = false)
		{
		...
		/// </summary>
		protected string DbBool(bool value)
		{
		...
		/// </summary>
		protected string DbVal<T>(Nullable<T> value) where T : struct
		{
